...
public partial class HeThongQuanLyHocTapContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=BEOSBUJ\\BEOSBUJ;Initial Catalog=HeThongQuanLyHocTap;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
